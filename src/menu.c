...
//���ӱ�բ����⹦��	2017-03-14
					else
					{
						...
						else if (vptr == &p.relevel)
						{
							...
							{//ֻ��˫��ϵͳ�����ô˹���
								if(save_double_door)
									{
										config_double_door();		//����˫��ϵͳ	
										accesstimer = 60;	
									}
							}
						else if(((BYTE *)vptr == &p.door_connect) && (drive_state == D_STOPPED))		//ֻ������ͣ��״̬�²ſ��ԸĶ�
							{
								if(*(BYTE *)vptr)
									{//������ǰ�������ں�
										p.hse_inpar [IO_SC2][IO_SUB_FUNC] = SC3;			//��Ӧ���������߶Ե������ͬ������
		...
		case M_RESET_MCU:
			...
			if (wait == 1)
				{
					if ((key) || (displaytimer < realtimer))	// ��ʹ��timer����Ϊ����para�������ɲ������Ҷ���cycle������,timer���ܵ���
						new = 1;
				}
			else if (wait == 2)
				{		
					if (menu == M_RESET_MCU)
						{
							...
							displaytimer = realtimer + 3 SEC;	// ��ʹ��timer����Ϊ����para�������ɲ������Ҷ���cycle������,timer���ܵ���
							wait = 3;
						}
				}
			else if (wait == 3)
						...
						else
						{
							...
							else
							{
								if (password_right <= paratext [paranumber].right)
								{
									...
									address = paratext [paranumber].index;		//����index����Ҫ��� NICE5000 ����
								}
								else
								{
									wait = 1;
