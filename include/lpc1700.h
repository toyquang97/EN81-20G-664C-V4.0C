...
#define ISE_TIMER0		(0x01ul << 1)
#define ISE_TIMER1		(0x01ul << 2)
#define ISE_TIMER2		(0x01ul << 3)
#define	ISE_TIMER3		(0x01ul << 4)
#define ISE_EINT1		(0x01ul << 19)
#define ISE_EINT3		(0x01ul << 21)
#define ISE_CAN		(0x01ul << 25)
