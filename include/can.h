...
#define CMD_TRAN_BUFF1			0x21		//������1����SDO֮�����Ϣ
#define CMD_TRAN_BUFF2			0x41		//������2��������
#define CMD_TRAN_BUFF3			0x81		//������3����SDO��Ϣ
#define CMD_CLR_RECV			0x04			//�ͷŽ��ջ�����
#define CMD_CLR_DATAOVERRUN	0x08		//������ݳ���λ
