...
/*
 * RCS $Revision: 154872 $ Codemist 0.03
 * Checkin $Date: 2010-05-06 12:03:39 +0100 (Thu, 06 May 2010) $
...
extern _ARMABI double hypot(double /*x*/, double /*y*/);
     ...
     */
extern _ARMABI_FPEXCEPT int ilogb(double /*x*/);
    /*
     * Exponent of x (returns 0 for 1.0, 1 for 2.0, -1 for 0.5, etc.)
     */
extern _ARMABI_FPEXCEPT int ilogbf(float /*x*/);
    /*
     * Like ilogb but takes a float
     */
extern _ARMABI_FPEXCEPT int ilogbl(long double /*x*/);
    /*
     * Exponent of x (returns 0 for 1.0, 1 for 2.0, -1 for 0.5, etc.)
     */
...
extern _ARMABI double log1p(double /*x*/);
     ...
     */
extern _ARMABI_FPEXCEPT double logb(double /*x*/);
    /*
     * Like ilogb but returns a double.
     */
extern _ARMABI_FPEXCEPT float logbf(float /*x*/);
    /*
     * Like logb but takes and returns float
     */
extern _ARMABI_FPEXCEPT long double logbl(long double /*x*/);
    /*
     * Like logb but takes and returns long double
     */
extern _ARMABI_FPEXCEPT double nextafter(double /*x*/, double /*y*/);
    /*
     * Returns the next representable number after x, in the
     * direction toward y.
     */
extern _ARMABI_FPEXCEPT float nextafterf(float /*x*/, float /*y*/);
    /*
     * Returns the next representable number after x, in the
     * direction toward y.
     */
extern _ARMABI_FPEXCEPT long double nextafterl(long double /*x*/, long double /*y*/);
    /*
     * Returns the next representable number after x, in the
     * direction toward y.
     */
extern _ARMABI_FPEXCEPT double nexttoward(double /*x*/, long double /*y*/);
    /*
     * Returns the next representable number after x, in the
     * direction toward y.
     */
extern _ARMABI_FPEXCEPT float nexttowardf(float /*x*/, long double /*y*/);
    /*
     * Returns the next representable number after x, in the
     * direction toward y.
     */
extern _ARMABI_FPEXCEPT long double nexttowardl(long double /*x*/, long double /*y*/);
    /*
     * Returns the next representable number after x, in the
     * direction toward y.
     */
extern _ARMABI_FPEXCEPT double remainder(double /*x*/, double /*y*/);
    /*
...
extern _ARMABI_FPEXCEPT double rint(double /*x*/);
     ...
     */
extern _ARMABI_FPEXCEPT double scalbln(double /*x*/, long int /*n*/);
    /*
     * Compute x times 2^n quickly.
     */
extern _ARMABI_FPEXCEPT float scalblnf(float /*x*/, long int /*n*/);
    /*
     * Compute x times 2^n quickly.
     */
extern _ARMABI_FPEXCEPT long double scalblnl(long double /*x*/, long int /*n*/);
    /*
     * Compute x times 2^n quickly.
     */
extern _ARMABI_FPEXCEPT double scalbn(double /*x*/, int /*n*/);
    /*
     * Compute x times 2^n quickly.
     */
extern _ARMABI_FPEXCEPT float scalbnf(float /*x*/, int /*n*/);
    /*
     * Compute x times 2^n quickly.
     */
extern _ARMABI_FPEXCEPT long double scalbnl(long double /*x*/, int /*n*/);
    /*
     * Compute x times 2^n quickly.
     */
#define signbit(x) \
...
#define FP_FAST_FMAL
#endif
extern _ARMABI_FPEXCEPT double fma(double /*x*/, double /*y*/, double /*z*/);
extern _ARMABI_FPEXCEPT float fmaf(float /*x*/, float /*y*/, float /*z*/);
_ARMABI_INLINE _ARMABI_FPEXCEPT long double fmal(long double __x, long double __y, long double __z) \
...
_ARMDEFLD1(log2);
extern _ARMABI_FPEXCEPT long lrint(double /*x*/);
extern _ARMABI_FPEXCEPT long lrintf(float /*x*/);
_ARMABI_INLINE _ARMABI_FPEXCEPT long lrintl(long double __x) \
    { return lrint((double)__x); }
extern _ARMABI_FPEXCEPT __int64 llrint(double /*x*/);
extern _ARMABI_FPEXCEPT __int64 llrintf(float /*x*/);
_ARMABI_INLINE _ARMABI_FPEXCEPT __int64 llrintl(long double __x) \
    { return llrint((double)__x); }
extern _ARMABI_FPEXCEPT long lround(double /*x*/);
extern _ARMABI_FPEXCEPT long lroundf(float /*x*/);
_ARMABI_INLINE _ARMABI_FPEXCEPT long lroundl(long double __x) \
    { return lround((double)__x); }
extern _ARMABI_FPEXCEPT __int64 llround(double /*x*/);
extern _ARMABI_FPEXCEPT __int64 llroundf(float /*x*/);
_ARMABI_INLINE _ARMABI_FPEXCEPT __int64 llroundl(long double __x) \
...
#undef _ARMDEFLD2
  ...
  extern "C++" {
    ...
    inline _ARMABI_FPEXCEPT long lrint(float __x) { return lrintf(__x); }
    inline _ARMABI_FPEXCEPT __int64 llrint(float __x) { return llrintf(__x); }
    inline _ARMABI_FPEXCEPT long lround(float __x) { return lroundf(__x); }
    inline _ARMABI_FPEXCEPT __int64 llround(float __x) { return llroundf(__x); }
    ...
    inline _ARMABI_FPEXCEPT long lrint(long double __x) { return lrintl(__x); }
    inline _ARMABI_FPEXCEPT __int64 llrint(long double __x) { return llrintl(__x); }
    inline _ARMABI_FPEXCEPT long lround(long double __x) { return lroundl(__x); }
    inline _ARMABI_FPEXCEPT __int64 llround(long double __x) { return llroundl(__x); }
